...
def create_fastwam(
    ...
    return FastWAM.from_ltx_video_only_pretrained(
        ...
        mot_checkpoint_stride=int(mot_checkpoint_stride),
        video_train_shift=float(video_scheduler.get("train_shift", 5.0)),
        video_infer_shift=float(video_scheduler.get("infer_shift", 5.0)),
        video_num_train_timesteps=int(video_scheduler.get("num_train_timesteps", 1000)),
        video_train_sigma_floor=float(video_scheduler.get("sigma_floor", 0.0)),
        video_scheduler_type=str(video_scheduler.get("type", "wan")),
        video_min_shift=float(video_scheduler.get("min_shift", 0.95)),
        video_max_shift=float(video_scheduler.get("max_shift", 2.05)),
        video_min_tokens=int(video_scheduler.get("min_tokens", 1024)),
        video_max_tokens=int(video_scheduler.get("max_tokens", 4096)),
        action_train_shift=float(action_scheduler["train_shift"]),
        action_infer_shift=float(action_scheduler["infer_shift"]),
        action_num_train_timesteps=int(action_scheduler["num_train_timesteps"]),
        action_train_sigma_floor=float(action_scheduler.get("sigma_floor", 0.0)),
        action_scheduler_type=str(action_scheduler.get("type", "wan")),
        action_min_shift=float(action_scheduler.get("min_shift", 0.95)),
        action_max_shift=float(action_scheduler.get("max_shift", 2.05)),
        action_min_tokens=int(action_scheduler.get("min_tokens", 1024)),
        action_max_tokens=int(action_scheduler.get("max_tokens", 4096)),
...
def create_fastwam_joint(
    ...
    return FastWAMJoint.from_a14b_high_noise_pretrained(
        device=device,
        torch_dtype=model_dtype,
        model_id=model_id,
...
def create_fastwam_idm(
    ...
    return FastWAMIDM.from_a14b_high_noise_pretrained(
        device=device,
        torch_dtype=model_dtype,
        model_id=model_id,
        tokenizer_model_id=tokenizer_model_id,
