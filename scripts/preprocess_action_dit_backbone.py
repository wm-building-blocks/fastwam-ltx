...
from fastwam.models.wan22.helpers.loader import load_wan22_a14b_high_noise_components
...
def main() -> None:
    ...
    components = load_wan22_a14b_high_noise_components(
        ...
        model_id=cfg.get("model_id", "Wan-AI/Wan2.2-T2V-A14B"),
        tokenizer_model_id=cfg.get("tokenizer_model_id", "Wan-AI/Wan2.2-T2V-A14B"),
